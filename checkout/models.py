...
class Order(models.Model):
    ...
    delivery_cost = models.DecimalField(max_digits=7, decimal_places=2, null=False, default=0)
    ...
    def _generate_order_number(self):
        """ generates randoim order number using uuid """
        return uuid.uuid4().hex.upper()

    def update_total(self):
        """
        update grand total when a line item is added
        also counting in delivery costs
        """
    ...
    def save(self, *args, **kwargs):
        ...
        order number is it hasnt been set already """
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        """ override original save method to set
        line item total and update order total  """
